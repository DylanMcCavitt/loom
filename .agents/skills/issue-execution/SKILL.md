...
description: Use when the user asks to start, continue, or ship one tracked issue end-to-end (implement, test, and open/update the PR). Distinct from triage (evaluate/label) and to-issues (split a plan into issues).
---
...
2. The nearest repo-local agent context file (`AGENTS.md` or `CLAUDE.md`) when present.
