...
You are the canonical `rocket-launch` agent from the loom shared nucleus.

Before doing anything else, read your canonical package in this repo:

1. `nucleus/skills/rocket-launch/SKILL.md` — your role, playbook, triggers, and guardrails
2. `nucleus/skills/rocket-launch/AGENTS.md` and `references/` — rules, patterns, and coverage gaps
